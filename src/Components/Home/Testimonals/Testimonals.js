...
import TestimonalsDetails from '../TestimonalsDetails/TestimonalsDetails';
    ...
    return (
      <section className="testimonials  my-5 py-5">
        <div className="container">
          ...
          <div className="row">
            {testimonialData.map((testimonal) => (
              <TestimonalsDetails testimonal={testimonal}></TestimonalsDetails>
            ))}
          </div>
        </div>
      </section>
